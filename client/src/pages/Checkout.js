...
const Checkout = () => {
    ...
    return (
        <Container style={{background: '#fff', borderRadius: '15px', width: '800px', padding: '20px 30px'}}>
            ...
            <h1 style={{textAlign: 'center'}} className="mb-4 mt-4">Оформление заказа</h1>
            <Form noValidate onSubmit={handleSubmit}>
                ...
                />
                <Button style={{width: '550px', marginLeft: '95px', marginTop: '20px'}} type="submit">Отправить</Button>
            </Form>
        </Container>
    )
}
